...
class Graph extends \EasyRdf\Graph
{
    ...
    public function dump($format = 'html')
    {
        $result = '';
        if ($format == 'html') {
            $result .= "<div class='rdf-title' style='font-family:arial; font-weight: bold; padding:0.5em; ".
    ...
    public function dumpResource($resource, $format = 'html')
    {
        ...
        foreach ($properties as $property => $values) {
            ...
            if ($format == 'html') {
                $plist []= "<span class='rdf-arrow' style='font-size:130%'>&rarr;</span> ".
                    "<span class='rdf-green-result' style='text-decoration:none;color:green'>".
                    htmlentities($pstr) . "</span> ".
                    "<span class='rdf-arrow' style='font-size:130%'>&rarr;</span> ".
                    join(", ", $olist);
            } else {
